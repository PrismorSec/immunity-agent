...
- 📑 [Attestation Bundle](docs/attestation-bundle.md) packages posture, agent inventory, and the trail anchor into one Ed25519-signed file an auditor re-verifies with `prismor attest verify`
