...
- **Hand auditors a signed evidence bundle** with `prismor attest`, packaging posture, agent inventory, and the trail anchor into one file anyone re-verifies with `prismor attest verify`
